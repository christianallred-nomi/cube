...
describe('Custom Granularities', () => {
  ...
  it('works with half_year custom granularity w/o dimensions query', async () => dbRunner.runQueryTest(
    ...
    [
      ...
      {
        orders__count: 13,
        orders__created_at_half_year: new Date('2024-06-30T00:00:00.000Z'),
      },
      {
        orders__count: 13,
        orders__created_at_half_year: new Date('2024-12-28T00:00:00.000Z'),
      },
      {
        orders__count: 13,
        orders__created_at_half_year: new Date('2025-06-27T00:00:00.000Z'),
      },
      {
        orders__count: 1,
        orders__created_at_half_year: new Date('2025-12-25T00:00:00.000Z'),
      },
    ],
  ...
  it('works with half_year_by_1st_april custom granularity w/o dimensions query', async () => dbRunner.runQueryTest(
    ...
    [
      {
        orders__count: 7,
        orders__created_at_half_year_by_1st_april: new Date('2023-10-03T00:00:00.000Z'),
      },
      {
        orders__count: 13,
      ...
      {
        orders__count: 13,
        orders__created_at_half_year_by_1st_april: new Date('2024-09-29T00:00:00.000Z'),
      },
      {
        orders__count: 13,
        orders__created_at_half_year_by_1st_april: new Date('2025-03-29T00:00:00.000Z'),
      },
      {
        orders__count: 7,
        orders__created_at_half_year_by_1st_april: new Date('2025-09-26T00:00:00.000Z'),
      },
    ],
    { joinGraph, cubeEvaluator, compiler }
  ));
